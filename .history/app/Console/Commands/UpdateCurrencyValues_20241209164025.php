    ...
    public function handle()
    {
        ...
        try {
            ...
            $allCurrencies = [
                ...
                ['source' => 'CBU', 'name' => 'USD', 'value' => $valuesFromSite2['USD'] ?? null],
                ['source' => 'CBU', 'name' => 'RUB', 'value' => $valuesFromSite2['RUB'] ?? null],
                ['source' => 'CBU', 'name' => 'EUR', 'value' => $valuesFromSite2['EUR'] ?? null],
            ];
