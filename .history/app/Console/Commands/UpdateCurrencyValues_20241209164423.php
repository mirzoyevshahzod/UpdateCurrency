...
class UpdateCurrencyValues extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $allCurrencies = [
                ['source' => 'Kapitalbank', 'name' => 'USD', 'value' => $valuesFromSite1['USD'] ?? null],
                ['source' => 'Kapitalbank', 'name' => 'RUB', 'value' => $valuesFromSite1['RUB'] ?? null],
                ['source' => 'Kapitalbank', 'name' => 'EUR', 'value' => $valuesFromSite1['EUR'] ?? null],
                ['source' => 'CBU', 'name' => 'CBU-USD', 'value' => $valuesFromSite2['USD'] ?? null],
                ['source' => 'CBU', 'name' => 'CBU-RUB', 'value' => $valuesFromSite2['RUB'] ?? null],
                ['source' => 'CBU', 'name' => 'CBU-EUR', 'value' => $valuesFromSite2['EUR'] ?? null],
            ];
            ...
            foreach ($allCurrencies as $currency) {
                if ($currency['value'] !== null) {
                    Currency::updateOrCreate(
                        ['name' => $currency['name'], 'source' => $currency['source']],
